...
const AboutMe = () => <div className='about-me-container'>
  ...
  <h2 className='paragraph'>JS Engineer</h2>
  <h2 className='paragraph'>Saxophonist</h2>
  <h2 className='paragraph'>&nbsp;</h2>
  <h4 className='paragraph'>Besides programming and music, I enjoy playing GTA5, The Elder Scroll 5 and FF14.</h4>
